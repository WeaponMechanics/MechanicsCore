...
public class CustomSoundMechanic extends Mechanic {
    ...
    public @NotNull NamespacedKey getKey() {
        return new NamespacedKey(MechanicsCore.NAMESPACE, "customsound");
    }
    ...
    protected @NotNull ConfigSchema.Builder schemaBuilder() {
        return super.schemaBuilder().stringKey("Sound").required().doubleKey("Volume").range(0.0, null).doubleKey("Pitch").range(0.5, 2.0).doubleKey("Noise").range(0.0, 1.5).enumKey("Category", SoundCategory.class).registrySerializerKey("Listeners", Targeters.REGISTRY).registrySerializerListKey("Listener_Conditions", Conditions.REGISTRY);
    }
