...
public class NonNullList_1_21_R4 extends NonNullList<ItemStack> {
    ...
    public NonNullList_1_21_R4(int size, TriIntConsumer<org.bukkit.inventory.ItemStack, org.bukkit.inventory.ItemStack> consumer) {
